// Typed client for the Agent Angelo backend API.
// Mirrors backend/src/shared/types.ts and web/src/api.ts.
...
// Backend runs on port 3001 in dev; in prod same origin.
